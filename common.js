...
function students_table_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function faculty_table_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function enrollment_table_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function exams_table_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
